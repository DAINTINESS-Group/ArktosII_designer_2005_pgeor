...
#Region " Custom Public Methods "
        ...
        Public Sub Remove(ByVal value As Constructs.Types.ReposFunctionType)
            myHash.Remove(value.ID)
            myList.Remove(value)
        End Sub

        Default Public Property Item(ByVal ID As Guid) As Constructs.Types.ReposFunctionType
            Get
                Item = CType(myHash.Item(ID), Constructs.Types.ReposFunctionType)
            End Get
            Set(ByVal Value As Constructs.Types.ReposFunctionType)
        ...
        Public Function ContainsValue(ByVal value As Constructs.Types.ReposFunctionType) As Boolean
            Return myHash.ContainsValue(value)
        End Function

        Public Sub Add(ByVal value As Constructs.Types.ReposFunctionType)
            myHash.Add(value.ID, value)
            myList.Add(value)
        End Sub

        Public Function Clone() As FunctionTypes
            Dim Cloned As New FunctionTypes
            Dim tListItem As Constructs.Types.ReposFunctionType
...
#Region " From IList "
        ...
        Public Function IndexOf(ByVal value As Constructs.Types.ReposFunctionType) As Integer
            Return myList.IndexOf(value)
        End Function

        Public Sub Insert(ByVal index As Integer, ByVal value As Constructs.Types.ReposFunctionType)
            myList.Insert(index, value)
            myHash.Add(value.ID, value)
        End Sub

        Default Public Property Item(ByVal index As Integer) As Constructs.Types.ReposFunctionType
            Get
                Item = CType(myHash(myList(index)), Constructs.Types.ReposFunctionType)
            End Get
            Set(ByVal Value As Constructs.Types.ReposFunctionType)
        ...
        Public Sub RemoveAt(ByVal index As Integer)
            myHash.Remove(CType(myList(index), Constructs.Types.ReposFunctionType).ID)
