...
#Region " Custom Public Methods "
        ...
        Public Sub Remove(ByVal value As Constructs.Types.ReposDataType)
            myHash.Remove(value.ID)
            myList.Remove(value)
        End Sub

        Default Public Property Item(ByVal ID As Guid) As Constructs.Types.ReposDataType
            Get
                Item = CType(myHash.Item(ID), Constructs.Types.ReposDataType)
            End Get
            Set(ByVal Value As Constructs.Types.ReposDataType)
        ...
        Public Function ContainsValue(ByVal value As Constructs.Types.ReposDataType) As Boolean
            Return myHash.ContainsValue(value)
        End Function

        Public Sub Add(ByVal value As Constructs.Types.ReposDataType)
            myHash.Add(value.ID, value)
            myList.Add(value)
        End Sub

        Public Function Clone() As DataTypes
            Dim Cloned As New DataTypes
            Dim tListItem As Constructs.Types.ReposDataType
...
#Region " From IList "
        ...
        Public Function IndexOf(ByVal value As Constructs.Types.ReposDataType) As Integer
            Return myList.IndexOf(value)
        End Function

        Public Sub Insert(ByVal index As Integer, ByVal value As Constructs.Types.ReposDataType)
            myList.Insert(index, value)
            myHash.Add(value.ID, value)
        End Sub

        Default Public Property Item(ByVal index As Integer) As Constructs.Types.ReposDataType
            Get
                Item = CType(myHash(myList(index)), Constructs.Types.ReposDataType)
            End Get
            Set(ByVal Value As Constructs.Types.ReposDataType)
        ...
        Public Sub RemoveAt(ByVal index As Integer)
            myHash.Remove(CType(myList(index), Constructs.Types.ReposDataType).ID)
