...
#Region " Custom Public Methods "
        ...
        Public Sub Remove(ByVal value As Graphics.Lines.Line)
            myHash.Remove(value.ID)
            myList.Remove(value)
        End Sub

        Default Public Property Item(ByVal ID As Guid) As Graphics.Lines.Line
            Get
                Item = CType(myHash.Item(ID), Graphics.Lines.Line)
            End Get
            Set(ByVal Value As Graphics.Lines.Line)
        ...
        Public Function ContainsValue(ByVal value As Graphics.Lines.Line) As Boolean
            Return myHash.ContainsValue(value)
        End Function

        Public Sub Add(ByVal value As Graphics.Lines.Line)
            myHash.Add(value.ID, value)
            myList.Add(value)
        End Sub

        Public Function Clone() As LineCollection
            Dim Cloned As New LineCollection
            Dim tListItem As Graphics.Lines.Line
...
#Region " From IList "
        ...
        Public Function IndexOf(ByVal value As Graphics.Lines.Line) As Integer
            Return myList.IndexOf(value)
        End Function

        Public Sub Insert(ByVal index As Integer, ByVal value As Graphics.Lines.Line)
            myList.Insert(index, value)
            myHash.Add(value.ID, value)
        End Sub

        Default Public Property Item(ByVal index As Integer) As Graphics.Lines.Line
            Get
                Item = CType(myHash(myList(index)), Graphics.Lines.Line)
            End Get
            Set(ByVal Value As Graphics.Lines.Line)
        ...
        Public Sub RemoveAt(ByVal index As Integer)
            myHash.Remove(CType(myList(index), Graphics.Lines.Line).ID)
